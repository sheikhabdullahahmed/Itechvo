    ...
    <div className="container  mx-auto p-6">
      ...
      <div className="grid  grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="info-item aos-init aos-animate bg-gray-100 p-6  drop-shadow-md  flex flex-col items-center" data-aos="fade" data-aos-delay="200">
          <FiPhoneCall className="text-4xl text-blue-600 mb-4" />
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 gap-6 lg:grid-cols-2'>
        <div className="info-item aos-init aos-animate bg-gray-100 p-6 drop-shadow-md  flex flex-col items-center" data-aos="fade" data-aos-delay="200">
          <MdOutlineMarkEmailUnread className="text-4xl text-blue-600 mb-4" />
        ...
        {/* Opening Hours Card */}
        <div className="info-item aos-init aos-animate bg-gray-100 p-6 drop-shadow-md  flex flex-col items-center" data-aos="fade" data-aos-delay="200">
          <FaUserClock className="text-4xl text-blue-600 mb-4" />
          <h3 className="text-xl font-semibold text-blue-900 mb-2">Opening Hours</h3>
      ...
      <div className="lg:col-span-2 sm:col-span-2    w-full p-6  rounded-lg ">
        <form className="w-full px-6 py-6 bg-gray-100  mx-auto max-w-lg">
          ...
          <div className="flex justify-center">
            <button className="w-64 mt-5 bg-blue-600 h-11 rounded font-semibold text-white text-lg">Send Message</button>
          </div>
        </form>
      </div>
    </div>
